using BlazorApp.HelseId.Hosting.Authentication;
using BlazorApp.HelseId.Services;
using Duende.AccessTokenManagement;
using Duende.AccessTokenManagement.DPoP;
using Duende.AccessTokenManagement.OpenIdConnect;
using Duende.IdentityModel.Client;
using BlazorApp.HelseId.Components;
...
namespace BlazorApp.HelseId.Hosting;
            ...
            options.Events.OnTokenValidated = async context =>
            {
                if (context != null)
                {
                    ...
                    .StoreTokenAsync(context.Principal!, new UserToken
                    {
                        ...
                        DPoPJsonWebKey = DPoPProofKey.ParseOrDefault(authenticationSettings?.ClientSecret)
                    });
                }
            };
