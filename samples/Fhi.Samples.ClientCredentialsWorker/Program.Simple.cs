...
namespace Client.ClientCredentialsWorkers
{
    public partial class Program
    {
        /// <summary>
        /// Sample of the simplest possible setup of a worker service using client credentials with private JWK authentication.
        /// </summary>
        /// <param name="args"></param>
        /// <returns></returns>
        public static IHostBuilder CreateHostBuilderSimple(string[] args) =>
           Host.CreateDefaultBuilder(args)
                .ConfigureAppConfiguration((hostingContext, config) =>
                {
                    config.AddJsonFile("appsettings.Simple.json", optional: false, reloadOnChange: true);
                })
